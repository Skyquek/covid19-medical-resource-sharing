...
<div class="container-fluid p-2 my-1 text-center margin-bottom:0px" style="background-color:white">
...
<div class="jumbotron1" style="margin-bottom:0px">
...
<div class="jumbotron2 text-center" style="margin-bottom:0px;height:40px">
